...
# data=pd.read_csv('/Users/ankit/Downloads/EDA_IB/New_Client_Data/streamlit/df_original_scenario_new_pbi.csv',parse_dates=['Lst.datum'])

# data2=pd.read_csv('/Users/ankit/Downloads/EDA_IB/New_Client_Data/streamlit/df_approach_1_pbi.csv',parse_dates=['updated_delivery_date'])
